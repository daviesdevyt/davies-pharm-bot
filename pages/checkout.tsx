...
const checkout = () => {
  ...
  return (
    <main className="min-h-screen space-y-5 p-5 text-white">
          ...
          product.map((items, i) => (
            ...
            >
              <div className="flex space-x-3">
                <img src={items.image} className=" h-[45px]" alt="Drug Image" />
                <div>
      ...
      {product.length !== 0 && <><section className="space-y-2">
        ...
        <div className="flex items-center space-x-3 rounded-[20px] bg-black p-[10px]">
          ...
          <div>
            <h1 className="font-medium ">Germoloids</h1>
            <h2 className="text-[15px] font-bold text-[#F6D211]">₦5,500</h2>
          </div>
        </div>
      </section>
      <section className="space-y-2">
        ...
        <div className="flex flex-col space-y-2 rounded-[20px] bg-black p-[10px]">
          ...
          <p className="border-b text-[10.57px]">
            Plot 681, Cadastral Zone C, OO, Research & Institution Area, Airport
            Road, Jabi
          </p>
      ...
      <section className="flex justify-between">
        ...
        <h1 className="font-medium">₦23,000</h1>
      </section>
